CREATE TABLE Towns (ID serial not null primary key, Town_Name text, Registration_Start varchar(3));
CREATE TABLE Registration_Numbers (ID serial not null primary key, Registration_Number text, FK_Town_ID int);
